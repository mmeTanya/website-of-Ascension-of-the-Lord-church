...
const Welcome = () => {
  return (
    <div className={s.welcome}>
      ...
      <p className={s.welcome__text}>Ми сподіваємося, що ця веб-сторінка допоможе Вам знайти відповіді на Ваші питання та надасть Вам всю необхідну інформацію про нашу парохію та нашу Церкву.</p>
    </div>
  )
}
